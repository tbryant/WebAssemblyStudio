...
export declare class Service {
    ...
    static loadFilesIntoProject(files: IFiddleFile[], project: Project, basePath?: string): Promise<any>;
    ...
    static validateWasmWithBinaryen(file: File, status?: IStatusProvider): Promise<void>;
